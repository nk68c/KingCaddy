...
public class Score_Activity2 extends AppCompatActivity {
    ...
    public void Scorecard(View v){
        ...
        players.get(1).setScore(1,Integer.parseInt(hole1.getText().toString()));
        players.get(1).setScore(2,Integer.parseInt(hole2.getText().toString()));
        players.get(1).setScore(3,Integer.parseInt(hole3.getText().toString()));
        players.get(1).setScore(4,Integer.parseInt(hole4.getText().toString()));
        players.get(1).setScore(5,Integer.parseInt(hole5.getText().toString()));
        players.get(1).setScore(6,Integer.parseInt(hole6.getText().toString()));
        players.get(1).setScore(7,Integer.parseInt(hole7.getText().toString()));
        players.get(1).setScore(8,Integer.parseInt(hole8.getText().toString()));
        players.get(1).setScore(9,Integer.parseInt(hole9.getText().toString()));


        int total = 0;
        for(int i = 1; i< 10; i++){

            total += players.get(1).getScore(i);
        }
